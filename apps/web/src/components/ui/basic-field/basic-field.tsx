...
export const BasicFieldAnatomy = defineStyleAnatomy({
    ...
    fieldAsterisk: cva("UI-BasicField__fieldAsterisk ml-1 text-status-error text-sm"),
    ...
    fieldErrorText: cva("UI-BasicField__fieldErrorText text-sm text-status-error"),
})
