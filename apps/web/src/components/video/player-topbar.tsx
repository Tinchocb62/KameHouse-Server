        ...
        <div className="absolute inset-x-0 top-0 flex items-center justify-between p-6 md:p-8 pointer-events-none z-[100] bg-gradient-to-b from-black/70 to-transparent">
            ...
            {onOpenInMpv && (
                <button
                    ...
                    title="Abrir en mpv"
                    className="flex items-center justify-center w-10 h-10 text-on-surface-variant bg-black/60 backdrop-blur-md will-change-[backdrop-filter] [transform:translateZ(0)] hover:text-on-surface hover:bg-surface-container-high border border-white/10 rounded-full transition-all duration-base active:scale-[0.95] group shrink-0 focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2 focus-visible:ring-offset-surface shadow-[var(--shadow-glass-liquid)]"
                >
                    <Icons.status.monitorPlay className="w-5 h-5 group-hover:scale-110 transition-transform duration-base" />
                </button>
            )}
            <button
                tabIndex={0}
                ...
                className="flex items-center justify-center w-10 h-10 text-on-surface-variant bg-black/60 backdrop-blur-md will-change-[backdrop-filter] [transform:translateZ(0)] hover:text-on-surface hover:bg-surface-container-high border border-white/10 rounded-full transition-all duration-base active:scale-[0.95] group shrink-0 pointer-events-auto focus-visible:ring-2 focus-visible:ring-brand-accent focus-visible:ring-offset-2 focus-visible:ring-offset-surface shadow-[var(--shadow-glass-liquid)]"
            >
                <Icons.ui.close className="w-5 h-5 group-hover:rotate-90 group-hover:scale-110 transition-transform duration-base" />
            </button>
            </div>
        </div>
    )
